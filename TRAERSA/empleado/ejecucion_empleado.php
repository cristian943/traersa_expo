...
$sql = "SELECT e.*, c.titulo AS servicio_titulo, c.tipo_entrega,
        ...
        WHERE e.estado IN ('Aprobada','Asignado','En ruta','No entregado')
        ORDER BY
            FIELD(e.estado, 'No entregado', 'En ruta', 'Asignado', 'Aprobada'),
...
<head>
    ...
    <title>En ejecución | Empleado TRAERSA</title>
...
<body>
    ...
    <aside class="sidebar fade-up" id="sidebar">
        ...
        <div class="menu-section">
            ...
            <a href="ejecucion_empleado.php" class="menu-item active">
    ...
    <div class="gallery-table">
        ...
        <?php else: ?>
            ...
            while ($fila = $resultado->fetch_assoc()):
                ...
                $estadoClase = 'running';
                if ($fila['estado'] === 'No entregado') $estadoClase = 'failed';
                if ($fila['estado'] === 'Aprobada') $estadoClase = 'warehouse';
            ?>
            ...
            <div class="gallery-row"
                ...
                <div class="row-actions-group">
                    <a class="row-icon-btn" href="orden_pdf.php?id=<?php echo (int) $fila['id_envio']; ?>" target="_blank" title="Ver orden de entrega (PDF)">
...
<!-- FOOTER -->
    ...
    <script>
        ...
        formEjecucion.addEventListener("submit", function(e){
            ...
            fetch("procesar_ejecucion_empleado.php", {
                method: "POST",
