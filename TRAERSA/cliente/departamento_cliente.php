...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <section class="hero-card" data-reveal>
            ...
            <p class="eyebrow">Envíos a Departamentos</p>

            <h1>
                ENVÍOS A <span>DEPARTAMENTOS</span>
            </h1>

            <p>
                Cobertura nacional para que tu carga llegue a cualquier departamento del país.
            </p>
        ...
        <section>
            ...
            <h2 class="section-title" data-reveal>Servicios — Departamentos</h2>
...
$sql = "SELECT * FROM categoria WHERE tipo_entrega='Departamentos'";
...
<div class="empty-state">
    ...
    Por el momento no hay servicios de tipo Departamentos disponibles.
</div>
<?php
} else {
...
<article class="service-card" data-reveal>
    ...
    <div class="service-media">
        <span class="service-tag"><i class="fa-solid fa-map-location-dot"></i> Departamentos</span>
