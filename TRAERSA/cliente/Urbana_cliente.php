...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <section class="hero-card" data-reveal>
            ...
            <p class="eyebrow">Envíos Urbanos</p>

            <h1>
                ENVÍOS <span>URBANOS</span>
            </h1>

            <p>
                Entregas ágiles dentro del área urbana, ideales para paquetes pequeños y mensajería.
            </p>
        ...
        <section>
            ...
            <h2 class="section-title" data-reveal>Servicios — Urbana</h2>
...
$sql = "SELECT * FROM categoria WHERE tipo_entrega='Urbana'";
...
<div class="empty-state">
    ...
    Por el momento no hay servicios de tipo Urbana disponibles.
</div>
<?php
} else {
...
<article class="service-card" data-reveal>
    ...
    <div class="service-media">
        <span class="service-tag"><i class="fa-solid fa-city"></i> Urbana</span>
