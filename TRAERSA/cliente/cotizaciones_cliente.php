...
// Cotizaciones del cliente logueado que todavía no han sido entregadas
...
<body>
    ...
    <main class="main-content" id="mainContent">
        ...
        <section class="hero-card" data-reveal>
            ...
            <p class="eyebrow">Gestión de envíos</p>

            <h1>
                COTIZACIONES <span>EN PROCESO</span>
            </h1>

            <p>
                Aquí puedes ver el estado real de tus solicitudes de transporte.
            </p>
        ...
        <section>
            ...
            <p class="eyebrow" data-reveal>Seguimiento</p>
            <h2 class="section-title" data-reveal>Tus cotizaciones</h2>
            ...
            <div class="services-grid">
                ...
                <?php if ($resultado->num_rows === 0): ?>
                    ...
                    <div class="empty-state">
                        ...
                        Todavía no tienes cotizaciones activas. Puedes pedir una desde el catálogo de servicios.
                    </div>
                ...
                <?php else: ?>
                    ...
                    <?php while ($fila = $resultado->fetch_assoc()):
                        ...
                        $estado = $fila['estado'];
                        $esDetenida = in_array($estado, ['Rechazada', 'Cancelado'], true);
                        ...
                        $etiquetasEtapas = ['Recibida', 'En revisión', 'Aprobada', 'En camino', 'Entregada'];
                        $etapaActual = isset($mapaEtapas[$estado]) ? $mapaEtapas[$estado] : 1;

                        $clasePill = ($estado === 'Pendiente' || $esDetenida) ? 'pendiente' : 'proceso';
                    ?>

                    <article class="service-card" data-reveal>
                        <div class="service-media">
                            <span class="status-pill <?php echo $clasePill; ?>">
                                <i class="fa-solid fa-<?php echo $esDetenida ? 'circle-xmark' : 'rotate'; ?>"></i>
                                <?php echo htmlspecialchars($estado); ?>
                            </span>
                            <img src="imagenes/cotizacion-default.jpg" alt="<?php echo htmlspecialchars($fila['servicio_titulo'] ?: 'Cotización'); ?>" onerror="this.onerror=null;this.removeAttribute('src');">
                        </div>
                        <div class="service-content">
                            ...
                            <?php if ($esDetenida): ?>
                                ...
                                <div class="stopped-badge">
                                    <i class="fa-solid fa-circle-info"></i>
                                    Esta cotización fue <?php echo strtolower(htmlspecialchars($estado)); ?>. Contáctanos si tienes dudas.
                                </div>
                            ...
                            <?php else: ?>
                                ...
                                <div class="tracker">
                                    <?php for ($i = 1; $i <= 5; $i++):
                                        $claseEtapa = '';
                                        if ($i < $etapaActual) $claseEtapa = 'done';
                                        elseif ($i === $etapaActual) $claseEtapa = 'active';
                                    ?>
                                        <div class="tracker-step <?php echo $claseEtapa; ?>">
                                            <div class="tracker-dot"></div>
                                            <div class="tracker-label"><?php echo $etiquetasEtapas[$i - 1]; ?></div>
                                        </div>
                                    <?php endfor; ?>
                                </div>
                            ...
                            <ul class="service-info">
                                ...
                                <li><i class="fa-solid fa-box"></i> <?php echo (int) $fila['paquetes']; ?> paquetes</li>
                                <?php endif; ?>
                                <?php if ($fila['peso']): ?>
